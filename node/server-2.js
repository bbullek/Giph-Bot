/* Similar to server.js, but this version downloads the GIF locally and
 * uploads it inline along with the content of the Tweet. Unsuitable for
 * running permanently on a server via Heroku (too much memory usage)
 */
